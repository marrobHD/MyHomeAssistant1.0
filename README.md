These are the Home Assistant configuration files used in the mar_robHD Home Automation project. Check out the [YouTube Series]() if you want to learn more about it! 
